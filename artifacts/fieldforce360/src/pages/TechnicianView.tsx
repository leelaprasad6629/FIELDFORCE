...
import { CheckSquare, Square, Loader2, DollarSign, Plus, X, RefreshCw } from "lucide-react";
...
export default function TechnicianView() {
  ...
  // Bug Fix #1: poll every 8 seconds so newly assigned tasks appear automatically
  useEffect(() => {
    load();
    ...
    <div className="p-6 space-y-6 max-w-4xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Your active assignments · auto-refreshes every 8s</p>
        </div>
